...
/**
 * Represents the state of a command that is stored in {@link CommandCache}. This class encapsulates
 * the {@link AbstractCommandModel} associated with the command and tracks the awaiting key, which
 * represent a state of a current command.
 *
