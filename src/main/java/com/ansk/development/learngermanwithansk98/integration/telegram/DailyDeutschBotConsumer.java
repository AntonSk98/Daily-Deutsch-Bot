...
/**
 * A consumer class for handling updates in a single-threaded, long-polling manner. This class
 * processes incoming updates by filtering them using a {@link FilterChain}. It then forwards the
 * message to the {@link InputGateway}.
 *
...
public class DailyDeutschBotConsumer implements LongPollingSingleThreadUpdateConsumer {
   ...
   */
  public DailyDeutschBotConsumer(
      BotConfigurationProperties config,
  ...
  /**
   * Consumes the given {@link Update} by filtering it and processing it through the {@link
   * InputGateway}.
   *
  ...
  /**
   * Ensures that the bot is running by periodically checking and starting the {@link
