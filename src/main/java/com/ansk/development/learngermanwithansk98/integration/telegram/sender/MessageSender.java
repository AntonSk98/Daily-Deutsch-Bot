...
public class MessageSender {
  ...
  public <T> void sendMessageWithPayload(Long chatId, String message, T payload) {
    try {
      ...
      SendMessage sendMessage =
          SendMessage.builder().parseMode("HTML").chatId(chatId).text(output).build();
      telegramClient.execute(sendMessage);
    } catch (TelegramApiException | JsonProcessingException e) {
      throw new IllegalStateException(
          "Unexpected error occurred while sending a message with payload to telegram", e);
    }
  }
  ...
  public void sendErrorMessage(Long chatId, Class<?> clazz, String message) {
    ...
    SendMessage sendMessage =
        SendMessage.builder().chatId(chatId).text(errorReport).parseMode("HTML").build();
  ...
  public void sendInformationPost(Long chatId, InformationPostModel informationPost) {
    ...
    SendMessage sendMessage =
        SendMessage.builder()
            ...
            .text(
                String.format(
                    informationPostTemplate, informationPost.topic(), informationPost.content()))
            .parseMode("HTML")
            .build();
    ...
    try {
      ...
      throw new IllegalStateException(
          "Unexpected error occurred while sending information post", e);
    }
  }
}
