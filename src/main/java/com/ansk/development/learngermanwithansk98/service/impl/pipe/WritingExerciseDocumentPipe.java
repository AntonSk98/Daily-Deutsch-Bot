 ...
 */
@Component
public class WritingExerciseDocumentPipe extends AbstractObjectToHtmlPipe<WritingExercise.Output>
    implements IConverterPipe<WritingExercise.Output, ExerciseDocument> {
   ...
   */
  protected WritingExerciseDocumentPipe(
  ...
  public ExerciseDocument pipe(WritingExercise.Output writingExercise) {
    Document html =
        abstractPipe("writing_exercise_template.html", "writingExercise", writingExercise);
