...
/**
 * This record encapsulates metadata related to rendering a document with text and its corrected
 * version,
 *
 * @param topic topic
 ...
 */
public record CorrectedTextDocumentMetadata(
    String topic, TextType textType, List<String> paragraphs) {
