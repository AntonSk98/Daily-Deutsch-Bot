...
public abstract class AbstractPublishExerciseSupport extends AbstractCommandProcessor {
   ...
   */
  protected AbstractPublishExerciseSupport(
  ...
  /**
   * Extension point that can be used to extend the publishing logic. The default implementation
   * does nothing.
   *
  ...
  /**
   * Encapsulates parameters that are exposed to the specific command handler to provide a
   * publishing hook.
   *
