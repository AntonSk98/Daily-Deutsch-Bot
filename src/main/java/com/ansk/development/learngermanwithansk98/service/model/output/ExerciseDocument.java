...
/**
 * A class representing a document consisting of multiple binary image pages. The {@code
 * ExerciseDocument} class provides functionality to add pages and retrieve an immutable list of the
 * pages.
 *
