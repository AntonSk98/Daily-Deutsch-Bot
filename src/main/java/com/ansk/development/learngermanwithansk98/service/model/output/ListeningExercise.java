...
/**
 * Represents the details of a listening exercise, including audio, tasks, and an associated
 * document. This record encapsulates the main components of a listening exercise.
 *
 ...
 * @param document the {@link ExerciseDocument} containing additional document details for the
 *     exercise
...
public record ListeningExercise(
  ...
  /**
   * Represents the structure for a listening exercise, including the level, title, and a list of
   * tasks.
   *
  ...
  /**
   * Represents a single task within a listening exercise, containing a question and its
  ...
  /**
   * Encapsulates the listening tasks for a given exercise, containing a list of individual {@link
   * Task} objects.
   *
  ...
  /**
   * Represents a document related to the listening exercise, including metadata like level, title,
   * and content such as paragraphs and questions.
   *
  ...
  public record Document(
      String level, String title, List<String> paragraphs, List<String> questions) {}
}
