 ...
 */
@Component
public class ListeningExerciseDocumentPipe
    extends AbstractObjectToHtmlPipe<ListeningExercise.Document>
    implements IConverterPipe<ListeningExercise.Document, ExerciseDocument> {
   ...
   */
  protected ListeningExerciseDocumentPipe(
